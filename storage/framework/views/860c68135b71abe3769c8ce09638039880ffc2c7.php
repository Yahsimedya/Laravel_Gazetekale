...
<?php $__env->startSection('admin'); ?>
    ...
    <?php $__currentLoopData = $themeSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('theme.update',$row->id)); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <fieldset class="mb-3">
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <select data-placeholder="Select your state" name="header"
                                            ...
                                            data-fouc>
                                        <option <?php if($row->header ==0 ) { echo "selected";} ?> value="0">Klasik
                                            Header
                                        </option>
                                        <option <?php if($row->header ==1 ) { echo "selected";} ?> value="1">Modern
                                            Header
                                        </option>
                                    </select>
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <select data-placeholder="Select your state" name="slider_title"
                                            style="width: 150px; height: 30px" class="form-control form-control-select2"
                                            data-fouc>
                                        <option <?php if($row->slider_title ==0 ) { echo "selected";} ?> value="0">
                                            Kapalı

                                        </option>
                                        <option <?php if($row->slider_title ==1 ) { echo "selected";} ?> value="1">
                                            Açık
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="example full" style="width: 100%; height: 30px">
                                        ...
                                        <input type="text" class="coloris" name="siteColorTheme"
                                               ...
                                               value="<?php echo e($row->siteColorTheme); ?>">
                                    </div>
                                ...
                                <div class="col-lg-5">
                                    <select data-placeholder="Select your state" name="category1"
                                        ...
                                        <?php $__currentLoopData = $Categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option
                                                value="<?php echo e($rows->id); ?>" <?php if($rows->id==$category1) {echo "selected";}  ?>>
                                                <?php echo e($rows->category_tr); ?>
                                ...
                                <div class="col-lg-2">
                                    <div class="example full" style="width: 100%; height: 30px">
                                        ...
                                        <input type="text" class="coloris"
                                               name="sport" style="width: 100%; height: 30px" value="<?php echo e($row->sport); ?>">
                                    </div>
                                ...
                                <div class="col-lg-5">
                                    <select data-placeholder="Select your state" name="category2"
                                        ...
                                        <?php $__currentLoopData = $Categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option
                                                value="<?php echo e($rows->id); ?>" <?php if($rows->id==$category2) {echo "selected";}  ?>>
                                                <?php echo e($rows->category_tr); ?>
                            ...
                            <!--   <label class="col-form-label col-lg-3">Öne Çıkan 3.Alan</label>
                                ...
                                <div class="col-lg-7">
                                    <select data-placeholder="Select your state" name="category3"
                                            ...
                                            data-fouc>
                                        <?php $__currentLoopData = $Categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($rows->id); ?>" <?php if($rows->id==$category3) {echo "selected";}  ?>>
                                                <?php echo e($rows->category_tr); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-lg-2">
                                ...
                                <option value="<?php echo e($rows->id); ?>" <?php if($rows->id==$category4) {echo "selected";}  ?>>
                                                <?php echo e($rows->category_tr); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <select data-placeholder="Select your state" name="apps"
                                            style="width: 150px; height: 30px" class="form-control form-control-select2"
                                            data-fouc>
                                        <option <?php if($row->apps ==0 ) { echo "selected";} ?> value="0">Gösterme

                                        </option>
                                        <option <?php if($row->apps ==1 ) { echo "selected";} ?> value="1">Göster
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <select data-placeholder="Select your state" name="subscription"
                                            style="width: 150px; height: 30px" class="form-control form-control-select2"
                                            data-fouc>
                                        <option <?php if($row->subscription ==0 ) { echo "selected";} ?> value="0">
                                            Gösterme

                                        </option>
                                        <option <?php if($row->subscription ==1 ) { echo "selected";} ?> value="1">
                                            Göster
                            ...
                            <!--     <label class="col-form-label col-lg-3">Çoklu Kategori</label>
                                    <div class="col-md-9">
                                        <select class="select" multiple name="multiple_category[]">
                                            ...
                                            <?php $__currentLoopData = $Categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($rows->id); ?>" <?php
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Laravel_Gazetekale\resources\views/backend/Theme/index.blade.php ENDPATH**/ ?>