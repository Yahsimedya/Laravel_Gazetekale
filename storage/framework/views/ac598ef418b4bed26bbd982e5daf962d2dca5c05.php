    ...
    <div class="sidebar-content">
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <a href="<?php echo e(route('cacheClean')); ?>" class="badge bg-success ml-md-3 mr-md-auto ">Önbellek Temizle</a>
                </li>
                <!-- Main -->
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                        <li class="nav-item"><a href="<?php echo e(route('district')); ?>" class="nav-link active">Bölgeler</a></li>
                        <li class="nav-item"><a href="<?php echo e(route('subdistrict')); ?>" class="nav-link">Alt Bölgeler</a></li>
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                        ...
                        <li class="nav-item"><a href="<?php echo e(route('all.post')); ?>" class="nav-link">Tüm Haberler</a></li>
...
"><i
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('fixedpage.index')); ?>" class="nav-link">
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                        ...
                        <li class="nav-item"><a href="<?php echo e(route('seo.setting')); ?>" class="nav-link">SEO Ayarları</a></li>
...
<!-- /main sidebar -->
<?php /**PATH C:\laragon\www\Laravel_Gazetekale\resources\views/admin/body/sidebar.blade.php ENDPATH**/ ?>