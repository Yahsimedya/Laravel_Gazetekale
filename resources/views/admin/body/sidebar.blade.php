    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-user">
            <div class="card-body">
                <div class="media">
                    <div class="mr-3">
                        <a href="#"><img src="/{{ $photo[0]->profile_photo_path }}" width="38" height="38"
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                <li class="nav-item-header d-lg-none">
                    <a href="{{ route('cacheClean') }}" class="badge bg-success ml-md-3 mr-md-auto ">Önbellek
                        Temizle</a>
                </li>
                <!-- Main -->
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                        <li class="nav-item"><a href="{{ route('categories') }}" class="nav-link active">Kategori</a>
                        </li>
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                        <li class="nav-item"><a href="{{ route('add.post') }}" class="nav-link active">Haber Ekle</a>
                        </li>
...
"><i
                ...
                <li class="nav-item nav-item-submenu">
                    <a href="#ads" class="nav-link"><i class="icon-gear"></i> <span>Köşe Yazarları
                            Yönetimi</span></a>
                ...
                <li class="nav-item nav-item-submenu">
                    <a href="#settings" class="nav-link"><i class="icon-user"></i> <span>Sabit Sayfalar</span></a>

                    <ul class="nav nav-group-sub" data-submenu-title="Layouts">

                        <li class="nav-item"><a href="{{ route('fixedpage.index') }}" class="nav-link active"><i
                                    class="icon-list"></i> <span>Tüm Sayfalar</span></a></li>
                ...
                <li class="nav-item nav-item-submenu">
                    <a href="#settings" class="nav-link"><i class="icon-user"></i> <span>Kullanıcı
                            İşlemleri</span></a>
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                        ...
                        <li class="nav-item"><a href="{{ route('seo.setting') }}" class="nav-link">SEO Ayarları</a>
                        </li>
