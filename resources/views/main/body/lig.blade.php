@php
    ...
    //print_r($fikstablo);
    //echo "</pre>";
    if (isset($tablo) && isset($fikstablo)) {
        ...
        for ($i = 0; $i < $satirsayi; $i++) {
            ...
            if ($i < 3) {
                echo '<td align="center" style="background-color:#28a745;color:white;" >' .
                    ($i + 1) .
                    '</td>
                        <th scope="row" style="font-size:10px;font-weight:500!important;">' .
                    $takimismi .
                    '</th>
              <td align="center" style="font-size:10px;font-weight:500!important;">' .
                    $galibiyet .
                    '</td>
              <td align="center" style="font-size:10px;font-weight:500!important;">' .
                    $beraberlik .
              ...
              <td align="center" style="font-size:10px;font-weight:500!important;">' .
                ...
                echo '<td align="center" style="background-color:red;color:white" >' .
                    ($i + 1) .
                    '</td>
                    <th scope="row" style="font-size:10px;font-weight:500!important;">' .
                    $takimismi .
