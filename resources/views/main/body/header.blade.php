        ...
        <div class="row">
                    ...
                    <ul class="nav sidebar-nav">
                        ...
                        @foreach ($Fullcategory as $categories)
                            <li class="nav-item active position-relative">
                                ...
                                <a class="nav-link "
                                    id="#{{ str_slug($categories->category_tr) . '/' . $categories->id }}"
                                    href="{{ URL::to('/category/' . str_slug($categories->category_tr) . '/' . $categories->id) }}">{{ $categories->category_tr }}
                        ...
                        <li class="list-group-item active position-relative">
                            <div class="nav-item-hover position-absolute"></div>
                            <a class="nav-link " href="{{ route('yerelhaberler') }}">İller <span
            ...
            <ul class="list-group list-group-horizontal my-auto top-menu" style="font-size: 15px;">
                ...
                <li class="list-group-item float-left border-right  pr-1 pl-1 border-0 w-100 bg-transparent"><i
                        ...
                        href="{{ route('nobetciEczane') }}">Nöbetçi
                        Eczane</a>
                </li>
                <li class="list-group-item float-left border-right pr-1 pl-1 border-0 w-100 bg-transparent"><i
                        class="fa fa-briefcase color-fume pr-1"></i><a class="color-fume"
                        href="{{ route('cenazeilanlari') }}">Cenaze
                        İlanları</a>
                </li>
