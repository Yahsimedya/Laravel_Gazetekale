        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            @foreach ($ilceler as $ilce)
                <li class="nav-item ilceler__nav-item pr-0">
                    ...
                    <a class="ilceler__nav-link  @if ($i == 0) active @endif"
                        id="pills-{{ $ilce->id }}-tab" data-toggle="pill" href="#pills-{{ $ilce->id }}"
                        role="tab" aria-controls="pills-{{ $ilce->id }}"
        ...
        <div class="tab-content " id="pills-tabContent">
            ...
            @foreach ($ilceler as $ilce)
                <div class="tab-pane fade @if ($k == 0) show active @endif "
                    id="pills-{{ $ilce->id }}" role="tabpanel" aria-labelledby="pills-profile-tab">
                                    ...
                                    <a href="{{ URL::to('/haber-' . str_slug($haber->title_tr) . '-' . $haber->id) }}">
                                        <div class="card d-inline-block  ">
                                            <img class="card-img-top tns-lazy-img img-fluid"
                                                onerror="this.onerror=null;this.src='image/logo/2021/12/61cae20554c80.61b9c9efc61e4.600801fbf2570-logo-yepyeni (2).png';"
