        ...
        <div
            ...
            <div class="col-sm-3 col-3 col-md-2 kurlar__col border-right">
                <div class="mt-2">
                    ...
                    <div class="kurfiyat">{{ number_format($kurlar['DOLAR']['satis'], 3) }} @if (number_format($kurlar['DOLAR']['oranyonu'], 2) > 0)
            ...
            <div class="col-sm-3 col-3 col-md-2 kurlar__col border-right">
                <div class="mt-2">
                    ...
                    <div class="kurfiyat">{{ number_format($kurlar['EURO']['satis'], 3) }} @if (number_format($kurlar['EURO']['oranyonu'], 2) > 0)
                            <i class="fa fa-sort-up align-middle pt-1 pr-1 text-success"></i>
                        @else
                            <i class="fa fa-sort-down align-middle pt-1 pr-1 text-danger mb-3 "></i>
                        @endif
            ...
            <div class="col-sm-3 col-3 col-md-2 kurlar__col border-right">
                <div class="mt-2">
                    ...
                    <div class="ku
                            rfiyat">
                        {{ number_format((float) $kurlar['ceyrekaltin']['satis'], 3) }} @if (isset($kurlar['ceyrekaltin']['oranyonu']) > 0)
                            <i class="fa fa-sort-up align-middle pt-1 pr-1 text-success"></i>
                        @else
                            <i class="fa fa-sort-down align-middle pt-1 pr-1 text-danger mb-3 "></i>
                        @endif
            ...
            <div class="col-sm-3 col-3 col-md-2 kurlar__col border-right">
                <div class="mt-2">
                    ...
                    <div class="kurfiyat">{{ number_format((float) $kurlar['ALTIN']['satis'], 3) }}@if (isset($kurlar['ALTIN']['oranyonu']) > 0)
                            <i class="fa fa-sort-up align-middle pt-1 pr-1 text-success"></i>
                        @else
                            <i class="fa fa-sort-down align-middle pt-1 pr-1 text-danger mb-3 "></i>
                        @endif
                ...
                <div class="row position-absolute kurlar__sosyal mx-auto ">
                    ...
                    @foreach ($socials as $social)
                        <div class="col-3 col-md-3 col-lg-3 border-right border-left p-0"><a
                                href="{{ $social->facebook }}" class="kurlar__sosyal-link "><i
                        ...
                        <div class="col-3 col-md-3 col-lg-3 border-right p-0"><a href="{{ $social->twitter }}"
                                class="kurlar__sosyal-link "><i class="fa fa-twitter kurlar__sosyal-link-i-2"></i></a>
                        </div>
                        <div class="col-3 col-md-3 col-lg-3 border-right p-0"><a href="{{ $social->instagram }}"
                                class="kurlar__sosyal-link "><i class="fa fa-instagram kurlar__sosyal-link-i-3"></i>
                            </a>
                        </div>
                        <div class="col-3 col-md-3 col-lg-3 border-right p-0"><a href="{{ $social->youtube }}"
                                class="kurlar__sosyal-link "><i class="fa fa-youtube kurlar__sosyal-link-i-4"></i> </a>
                        </div>
                    @endforeach
