                ...
                <form action="{{ route('seos.update', $seos->id) }}" method="post">
                    ...
                    <fieldset class="mb-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="meta_author" value="{{ $seos->meta_author }}"
                                    class="form-control">
                                @error('meta_author')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="meta_title" value="{{ $seos->meta_title }}"
                                    class="form-control">
                                @error('meta_title')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="meta_keyword" value="{{ $seos->meta_keyword }}"
                                    class="form-control">
                                @error('youtube')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="google_verification" value="{{ $seos->google_verification }}"
                                    class="form-control">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="adsense_code" value="{{ $seos->adsense_code }}"
                                    class="form-control">
                                {{-- <textarea name="google_verification" id="" cols="30" rows="10">{{$seos->google_verification}}</textarea> --}}
                                @error('adsense_code')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-2">FCM Kodu</label>
                            <div class="col-lg-10">
