...
//FRONTEND ROUTES
//authors
Route::get('/koseyazisi/{slug}/{id}', [ExtraController::class, 'yazilar'])->name('authors.yazilar');
...
Route::get('/json/reklamsliderust', [MobilAppController::class, 'reklamsliderust']);
Route::get('/json/reklamhaberdetayust', [MobilAppController::class, 'reklamhaberdetayust']);
...
Route::get('/json/egazete/', [MobilAppController::class, 'egazete']);
...
Route::get('/videogaleri/all', [ExtraController::class, 'VideoGaleriAll'])->name('VideoGaleriAll');
